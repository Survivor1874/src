...
abstract class AbstractPipeline<E_IN, E_OUT, S
    ...
    final <P_IN> Sink<P_IN> wrapSink(Sink<E_OUT> sink) {
        ...
        for (@SuppressWarnings("rawtypes") AbstractPipeline pipelineElement = AbstractPipeline.this; pipelineElement.depth > 0; pipelineElement = pipelineElement.previousStage) {
            sink = pipelineElement.opWrapSink(pipelineElement.previousStage.combinedFlags, sink);
        }
